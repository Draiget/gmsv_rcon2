...
// Pointing to "mov ecx, [ebp+pNetworkListener]" -> 8B 4D 08
#define SIG_CSERVERREMOTEACCESS_WRITEDATAREQUEST_CASE3_GOTO_LOC \
		"\\x8B\\x2A\\x2A\\x8D\\x2A\\x2A\\x2A\\x2A\\x2A\\x50\\xE8\\x2A\\x2A\\x2A\\x2A\\x84\\x2A\\x75"
